...
import TranslateInOut from "../animations/CardTranslate"; 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 md:px-8 lg:px-16 mb-8 max-w-[1490px]">
        {project.map((item, index) => (
          <TranslateInOut 
            ...
            watch
          >
            <div className="group flex flex-col bg-white shadow-sm border border-gray-100 rounded-3xl transition-all duration-300 
                          hover:border-[rgb(var(--color-primary))] hover:shadow-md overflow-hidden h-full">
